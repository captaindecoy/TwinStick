...
draw_text_ext_transformed(room_width / 2, 200, message1, 2, 10000, .15, .15, 0);
draw_text_ext_transformed(room_width / 2, 226, message2, 2, 10000, .15, .15, 0);
draw_text_ext_transformed(room_width / 2, 250, message3, 2, 10000, .15, .15, 0);
draw_text_ext_transformed(room_width / 2, 274, message4, 2, 10000, .15, .15, 0);
